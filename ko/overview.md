...
이미지 빌더(Image Builder)는 NHN Cloud 상의 OS 이미지를 기반으로 사용자의 요구 사항에 맞는 개인 이미지를 생성하는 서비스입니다.

## 서비스 특징
* NHN Cloud가 제공하는 OS 이미지 또는 개인 이미지와 애플리케이션 설치 구성 요소, 사용자 스크립트를 조합해 간편하게 개인 이미지를 만들 수 있습니다.
