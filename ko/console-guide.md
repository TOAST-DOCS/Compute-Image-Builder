...
## Compute > Image Builder > 콘솔 사용 가이드 { #compute-image-builder-console-user-guide }

<a id="create-image-template"></a>
### 이미지 템플릿 생성 { #create-image-template }
